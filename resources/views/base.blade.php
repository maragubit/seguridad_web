...
<head>
    ...
    <title>@yield('title', 'Web Guardian')</title>
    <!-- Fonts -->
    ...
    <script src="/Datatable/datatable_acents.js"></script>
    <script src="/Datatable/datatableload.js"></script>
        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                ...
                <div>
                    ...
                    <a class="text-light" href="https://www.linkedin.com/company/106318666/" ><i class="fab fa-linkedin fa-sm fa-fw"></i></a>
                </div>
                <div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">Web Guardian</h2>
            ...
            <div class="row text-light mb-4">
                ...
                <div class="col-auto me-auto">
                    <ul class="list-inline text-left footer-icons">
                        ...
                        <li class="list-inline-item border border-light rounded-circle text-center">
                            <a class="text-light text-decoration-none" target="_blank" href="https://www.linkedin.com/company/106318666/"><i class="fab fa-linkedin fa-lg fa-fw"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-GCTPTC318N"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-GCTPTC318N');
</script>
<script>
