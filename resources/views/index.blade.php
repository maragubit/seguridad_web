...
@section('content')
 ...
 <div class="modal fade bg-white" id="templatemo_search" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                <h1 class="h1">OWASP</h1>
                                <h3 class="h2">The Open Worldwide Application Security Project</h3>
                                <p>
        ...
        <a class="carousel-control-prev text-decoration-none w-auto ps-2" href="#template-mo-zay-hero-carousel" role="button" data-bs-slide="prev">
            <i class="fas fa-chevron-left"></i>
        </a>
        <a class="carousel-control-next text-decoration-none w-auto pe-2" href="#template-mo-zay-hero-carousel" role="button" data-bs-slide="next">
